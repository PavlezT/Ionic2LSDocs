...
export const siteUrl = 'https://lsdocsagain.sharepoint.com/sites/LSDocs';//'https://lsdocs.ext5.lizard.net.ua/sites/lsdocs';//'';
export const site_realm = '9615f6e0-0ae4-4cc3-b161-2a987f221db4';//'1a811b22-8b2e-453c-8191-0bbc0371de8a';//'';
