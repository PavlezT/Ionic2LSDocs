...
export const siteUrl = 'https://lsdocs.ext5.lizard.net.ua/sites/lsdocs' ;//https://stabledocs.sharepoint.com/sites/stablelsdocs';//';
export const site_realm = '48f013c2-f1ed-4394-acf2-1d2bfd21b32c';//'1a811b22-8b2e-453c-8191-0bbc0371de8a';
export const OnPremise = true;
